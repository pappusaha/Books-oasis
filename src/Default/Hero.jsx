...
const Hero = () => {
    return (
        ...
        <div className="hero-content flex-col justify-between items-center lg:flex-row-reverse w-10/12 mx-auto ">
          ...
          <div className=' '>
            <h1 className="text-4xl w-full mb-10 md:text-5xl lg:text-6xl  font-bold md:w-2/3 "><span className='bg-gradient-to-r from-orange-700 via-blue-500 to-green-400 text-transparent bg-clip-text animate-gradient bg-300%'> Books to freshen up your bookshelf!</span></h1>
